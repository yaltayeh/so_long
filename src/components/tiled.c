...
/*   Updated: 2024/12/10 15:08:50 by yaltayeh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	update_tiled_data(t_tiled_data *t)
{
	...
	t->bounds[0] = (t_clip){offset + t->size, t->size, t->size, t->size};
	t->bounds[1] = (t_clip){offset + t->size, 0, t->size, t->size};
	t->bounds[2] = (t_clip){offset + t->size * 2, 0, t->size, t->size};
	t->bounds[3] = (t_clip){offset + t->size * 2, t->size, t->size, t->size};
	t->bounds[4] = (t_clip){offset + 0, t->size * 4, t->size, t->size};
	t->bounds[5] = (t_clip){offset + 0, t->size * 2, t->size, t->size};
	t->bounds[6] = (t_clip){offset + t->size * 2, t->size * 2, t->size, t->size};
	t->bounds[7] = (t_clip){offset + t->size * 2, t->size * 4, t->size, t->size};
	t->bounds[8] = (t_clip){offset + t->size, t->size * 2, t->size, t->size};
	t->bounds[9] = (t_clip){offset + t->size * 2, t->size * 3, t->size, t->size};
	t->bounds[10] = (t_clip){offset + t->size, t->size * 4, t->size, t->size};
	t->bounds[11] = (t_clip){offset + 0, t->size * 3, t->size, t->size};
	...
	t->main = (t_clip){offset + t->size, t->size * 3, t->size, t->size};
	return (1);
}
